...
final class XCodeSummaryTests: XCTestCase {
    func testItParsesWarningsCorrectly() {
        ...
        XCTAssertEqual(summary.warnings, [
            ...
            Result(message: "Test", file: "/Users/franco/Projects/DangerSwiftXCodeSummary/Sources/DangerSwiftXCodeSummary/XCodeSummary.swift", line: 26)
        ])
    }
    ...
    func testItParsesErrorsCorrectly() {
        ...
        XCTAssertEqual(summary.errors[0], Result(message: "error: Build input file cannot be found: '/Users/franco/Projects/DangerSwiftXCodeSummary/Test.swift'"))
